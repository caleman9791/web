...
<html>
	...
	<body class="skin-blue fixed">
		...
		<div class="wrapper">
			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					<!-- Sidebar user panel -->
					<div caleman9791="user-panel" class="user-panel">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="callout callout-info">
						...
						<p>
							Estos son los temas en los que he he trabajado estos últimos diez años. Estaré empleando los componentes de interfaz de usuario de esta plantilla para mostrar como logramos que nuestra aplicación tenga sentido y realmente provea beneficios empresariales.
						</p>
						<p>
							Curso de HTML
						</p>
		...
		<script type="text/javascript" src="./_caleman9791/app/js/index/app.js"></script>
	</body>
</html>
